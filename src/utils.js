...
findMiner: function(creep)
{
    ...
    var candidates = creep.room.find(FIND_CREEPS, {
                    filter: (targetCreep) => {
                        return   targetCreep.memory !=null && targetCreep.memory.role=='miner' && targetCreep.energy == targetCreep.energyCapacity;
                    }})
...
chooseMiner: function(creep)
{
    ...
    var candidates = creep.room.find(FIND_CREEPS, {
        filter: (targetCreep) => {
            return  targetCreep.memory !=null && targetCreep.memory.role=='miner';
        }})
